...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO XRP", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WKjQEx8W6dmEx4nmzoE1utQoZeq4HC5fSZ")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "XRP", WalletID: walletID, Required: 1, Symbol: "XRP", IsTrust: true}
...
func TestWalletManager_GetAddressList(t *testing.T) {
	...
	//walletID := "WKjQEx8W6dmEx4nmzoE1utQoZeq4HC5fSZ"
	//accountID := "9KKHEYZMFQJivQKkwCRTzPuQxUK2Arp71HRVP6zxK7Sj"
	walletID := "WJX9kac46kUuaWS6cHhknUmYg33QgAXsQ9"
	accountID := "2xh2GfXd674Er2Xi77Kgry2XPC4cP4PESZQ73JWz8V9X"

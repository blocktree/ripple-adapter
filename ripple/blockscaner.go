...
//NewXRPBlockScanner 创建区块链扫描器
func NewXRPBlockScanner(wm *WalletManager) *XRPBlockScanner {
	bs := XRPBlockScanner{
...
func (bs *XRPBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *XRPBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *XRPBlockScanner) ScanBlock(height uint64) error {
...
func (bs *XRPBlockScanner) ScanTxMemPool() {
...
func (bs *XRPBlockScanner) RescanFailedRecord() {
...
func (bs *XRPBlockScanner) newBlockNotify(block *Block, isFork bool) {
...
func (bs *XRPBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
...
func (bs *XRPBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *XRPBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
//func (bs *XRPBlockScanner) SaveRechargeToWalletDB(height uint64, list []*openwallet.Recharge) error {
//
//	for _, r := range list {
//
...
func (bs *XRPBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *XRPBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *XRPBlockScanner) GetScannedBlockHeight() uint64 {
...
//func (bs *XRPBlockScanner) DropRechargeRecords(accountID string) error {
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
//func (bs *XRPBlockScanner) DeleteRechargesByHeight(height uint64) error {
//
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
func (bs *XRPBlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
// func (bs *XRPBlockScanner) GetWalletByAddress(address string) (*openwallet.Wallet, bool) {
// 	bs.mu.RLock()
// 	defer bs.mu.RUnlock()
...
func (bs *XRPBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *XRPBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *XRPBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
//Run 运行
func (bs *XRPBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *XRPBlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *XRPBlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *XRPBlockScanner) Restart() error {
...
func (bs *XRPBlockScanner) setupSocketIO() error {
...
//@optional
func (bs *XRPBlockScanner) SupportBlockchainDAI() bool {
	return true
}